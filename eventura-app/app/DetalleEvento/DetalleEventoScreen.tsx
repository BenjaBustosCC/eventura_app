...
export default function DetalleEventoScreen() {
  const route =
    useRoute<RouteProp<RootStackParamList, "DetalleEventoScreen">>();
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.titulo}>
          {evento.nombre || evento.titulo || "Evento sin nombre"}
        </Text>

        <View style={styles.infoRow}>
          <Ionicons name="calendar" size={20} color="#BB271A" />
          <Text style={styles.infoText}>
            {evento.fecha || evento.fecha_evento || "Sin fecha"}
          </Text>
        </View>
